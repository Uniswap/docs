...
![Create Subgraph](/unichain/create-subgraph.png)

You'll land on your subgraph's page with all CLI commands visible on the right side.

![Subgraph Commands](/unichain/subgraph-commands.png)
...
![Initialization Prompts](/unichain/init-prompts.png)
...
![Playground Test](/unichain/playground-test.png)
...
![Publish Subgraph](/unichain/publish-subgraph.png)
...
![CryptoPunks Example](/unichain/cryptopunk.png)
...
![API Keys](/unichain/api-keys.png)
