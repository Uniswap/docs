...
See the [TokenJar contract source](https://github.com/Uniswap/protocol-fees/blob/main/src/TokenJar.sol) for more.

### Fee adapters

Adapters that connect specific protocol versions or products to the TokenJar. They define how and when fees are collected.

See the [Fee Adapter contract sources](https://github.com/Uniswap/protocol-fees/tree/main/src/feeAdapters) for more.
...
See the [Releaser contract sources](https://github.com/Uniswap/protocol-fees/tree/main/src/releasers) for more.
