---
description: Fetch Uniswap v3 position data and decode position state with the SDK and periphery contracts.
title: Fetching Positions with the v3 SDK
sidebarTitle: Fetching Positions
---
