...
For research into the economics of AMMs, game theory, or optimization research, check out our [**research**](https://docs.niftyleague.com/protocol/concepts/advanced/research) page.

For new features implemented in V3 that expand and refine the AMM design, see the [**V3 Concepts**](https://docs.niftyleague.com/protocol/concepts/V3-overview/concentrated-liquidity) page.
