...
You can look up the address of an existing pool on [Uniswap Info](https://info.niftyleague.com/#/) or by calling the [`getPool`](https://docs.niftyleague.com/protocol/reference/core/interfaces/IUniswapV3Factory#getpool) function on the `UniswapV3Factory` contract.
