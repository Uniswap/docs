...
In the following sections, we’ll walk through the steps to create the environment set up as the boiler plate from scratch and learn the underlying concepts.  
