...
3. Create a new hardhat config file, which you can use for compiling and testing contracts. For an example of how a typical smart contract repo is structured, select the "create a sample project" option during setup.
