...
Only one [JSON-RPC Endpoint](#json-rpc-endpoint) parameter is strongly recommended as described below. Also, if you already have a [Web3 provider](#web3-provider) in your dApp, you should pass that provider object in. Additional [optional parameters](/sdk/widgets/swap-widget/api#optional-parameters) are available to customize the appearance and performance of the swap widget to fit your unique use case.
...
// Recommended to provide an Infura endpoint
