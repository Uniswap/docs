...
This guide walks you through the steps to embed the swap widget in your website in 5 minutes — whether your site is already a decentralized application (dApp) or not. With the swap widget, your users can trade ERC-20 tokens on the Uniswap Protocol without leaving your site!
...
Only a [JSON-RPC Endpoint](#json-rpc-endpoint) parameter is strongly recommended as described below. Also, if you already have a [Web3 provider](#web3-provider) in your dApp, you should pass that provider object in. Additional [optional parameters](/sdk/widgets/swap-widget/api#optional-parameters) are available to customize the appearance and performance of the swap widget to fit your unique use case.
...
<!-- FIXME(kristiehuang): Update possible states bc JSON-RPC will now have fallback -->
