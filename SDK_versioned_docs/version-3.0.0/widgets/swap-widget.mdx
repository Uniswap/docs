...
### Using RainbowKit / WAGMI Provider {#rainbowkit}
If you're using [RainbowKit](https://www.rainbowkit.com/) or [WAGMI](https://wagmi.sh/) you can get the swap widget working by simply following the code sample below:
