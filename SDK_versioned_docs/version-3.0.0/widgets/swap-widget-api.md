...
| `onClickConnectWallet`      | `(e?: React.MouseEvent<HTMLButtonElement, MouseEvent>) => void` | `undefined`             | This callback is triggered when the 'Connect your wallet' message in the widget is clicked, and can be used to trigger your own wallet connection flow from the widget. Disable the built-in wallet connection flow by calling `e?.preventDefault()`.                                                                                                                                                                                                                                                                                |
