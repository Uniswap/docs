...
Ранее мы раздали наши первые 4 страницы комиксов минтерам, и в начале 2022 года осталось 2 страницы для держателей DEGEN. Слово от Сатоши — полная коллекция или 2 — это _настоятельно рекомендуется_
