...
function BlogTagsListPage(props) {
  ...
  return <_Layout.default title="Tags" description="Blog Tags" wrapperClassName={_themeCommon.ThemeClassNames.wrapper.blogPages} pageClassName={_themeCommon.ThemeClassNames.page.blogTagsListPage} searchMetadatas={{
