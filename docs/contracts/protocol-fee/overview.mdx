...
The system consists of three core layers that work together on any chain where they are deployed:
...
The first deployment of this system will enable Uniswap v2 and v3 fee collection on Ethereum mainnet. The contracts required for this deployment are:
