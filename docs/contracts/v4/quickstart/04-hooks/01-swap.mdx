...
When triggering the `beforeSwap` hook function, there are some parameters we can make use of to customize or extend the behavior of `swap`. These parameters are described in [`beforeSwap`](https://github.com/Uniswap/v4-core/blob/main/src/interfaces/IHooks.sol#L103) from `IHooks`.
...
- `params` The parameters for the swap i.e. [`SwapParams`](https://github.com/Uniswap/v4-core/blob/main/src/interfaces/IPoolManager.sol#L143) from `IPoolManager`
...
When triggering the `afterSwap` hook function, there are some parameters we can make use of to customize or extend the behavior of `swap`. These parameters are described in [`afterSwap`](https://github.com/Uniswap/v4-core/blob/main/src/interfaces/IHooks.sol#L118) from `IHooks`.
