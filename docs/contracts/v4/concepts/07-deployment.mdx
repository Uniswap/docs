...
2. **CREATE2**: This is a special way. Here, you use your address, a `salt` which is a unique number you choose, and
...
contract CounterScript is Script {
    ...
    function run() public {
        ...
        vm.broadcast();
        Counter counter = new Counter{salt: salt}(IPoolManager(address(POOLMANAGER)));
...
Note: This is a Foundry script, and it wont work for hardhat.
