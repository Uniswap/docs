...
## Implement the Hook
Let us create a ook of type BaseHook and just set beforeSwap as true as that is what we are going to use here.
...
Let us start with a basic beforeSwap hook.
...
> Here some examples of trusted routers:
