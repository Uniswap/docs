...
uint8 constant SETTLE_PAIR = 10;    // For negative deltas: Pay two tokens to the pool
uint8 constant TAKE_PAIR = 11;      // For positive deltas: Receive two tokens from the pool
...
1. **Standard Case**: Receive all tokens
