...
:::note Swap Widget
These docs are deprecated. Please refer to [Swap Widget](https://docs.uniswap.org/sdk/swap-widget/overview) to embed the Uniswap swap widget as a React component in your website in 2 minutes.
:::
