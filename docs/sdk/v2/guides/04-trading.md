...
This guide will focus exclusively on sending a transaction to the [currently recommended Uniswap router](../../../contracts/v2/reference/smart-contracts/router-02)
