...
| `tickCumulative`| int56 | the current tick multiplied by seconds elapsed for the life of the pool as of the observation,
| `liquidityCumulative` | uint160 | the current liquidity multiplied by seconds elapsed for the life of the pool as of the observation,
